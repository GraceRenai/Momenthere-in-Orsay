...
import com.momenthere.communication.HttpUtils;
import com.momenthere.login.Message;
import com.momenthere.login.Postcard;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Toast.makeText(getApplicationContext(),"Welcome to MomentHere in Orsay",
